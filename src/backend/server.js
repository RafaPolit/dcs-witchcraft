...
io.sockets.on("connection", function (socket) {
  ...
  socket.on("init", function (data) {
    socket.emit("missionModelChange", {
      type: "loadMission",
      mission: missionModel.toMission(),
    });
  });
...
var dcsconnector = net
  .createServer(function (dcs_socket) {
